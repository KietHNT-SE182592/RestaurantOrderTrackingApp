...
class WaiterPosPage extends StatelessWidget {
  const WaiterPosPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Gọi món (POS)')),
      body: const _PlaceholderBody(
        icon: Icons.point_of_sale,
        title: 'POS — Gọi món',
        subtitle: 'Chọn bàn → chọn món → gửi order về bếp',
      ),
    );
  }
}
